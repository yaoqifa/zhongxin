...
_mutationTypes.CHANGE_TAGS, function (state, _ref) {var type = _ref.type,tags = _ref.tags;
  var tagMap = {
    1: 'hobbyTags',
    2: 'travelTags',
    3: 'foodTags',
...
_mutationTypes.CHANGE_SELECTED_TAGS, function (state, _ref2) {var type = _ref2.type,tags = _ref2.tags;
  var tagMap = {
    1: 'selectedHobbyTags',
...
var actions = {
  changeTags: function changeTags(ctx, params) {
    ctx.commit(_mutationTypes.CHANGE_TAGS, params);
  },
  changeSelectedTags: function changeSelectedTags(ctx, params) {
    ctx.commit(_mutationTypes.CHANGE_SELECTED_TAGS, params);
  } };
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _mutationTypes = __webpack_require__(/*! ./mutation-types */ 18);function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.CHANGE_SELECTED_TAGS = exports.CHANGE_TAGS = exports.SET_TEST_INFO = void 0;var SET_TEST_INFO = 'SET_TEST_INFO';exports.SET_TEST_INFO = SET_TEST_INFO;
var CHANGE_TAGS = 'CHANGE_TAGS';exports.CHANGE_TAGS = CHANGE_TAGS;
var CHANGE_SELECTED_TAGS = 'CHANGE_SELECTED_TAGS';exports.CHANGE_SELECTED_TAGS = CHANGE_SELECTED_TAGS;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/tabbar/index/index": { "navigationBarTitleText": "zhongxin", "enablePullDownRefresh": true }, "pages/tabbar/square/square": {}, "pages/tabbar/message/message": {}, "pages/tabbar/personal/personal": {}, "pages/editInfo/editInfo": { "navigationBarTitleText": "编辑资料" }, "pages/dynamics/dynamics": { "navigationBarTitleText": "我的动态" }, "pages/coupon/coupon": { "navigationBarTitleText": "桃花券" }, "pages/setting/setting": { "navigationBarTitleText": "设置" }, "pages/tags/tags": { "navigationBarTitleText": "" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#fff", "backgroundColor": "#fff" } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.characterTags = exports.characterMap = exports.foodTags = exports.foodMap = exports.travelTags = exports.travelMap = exports.hobbyTags = exports.hobbyMap = exports.tagTitleMap = void 0;var tagTitleMap = {
  1: '兴趣爱好',
  2: '旅行',
  3: '食物',
  4: '性格' };exports.tagTitleMap = tagTitleMap;
...
var hobbyMap = {
  ...
  7: '猫奴',
  8: '宠物',
  9: 'K歌达人' };exports.hobbyMap = hobbyMap;
...
{ label: '二次元', value: 2 },
{ label: '买买买', value: 3 },
{ label: 'freestyle', value: 4 },
{ label: '摄影', value: 5 },
{ label: '跑步', value: 6 },
{ label: '猫奴', value: 7 },
{ label: '宠物', value: 8 },
{ label: 'K歌达人', value: 9 }];exports.hobbyTags = hobbyTags;
...
var travelMap = {
  ...
  7: '漠河',
  8: '哈尔滨',
  9: '呼伦贝尔' };exports.travelMap = travelMap;
...
{ value: 7, label: '漠河' },
{ value: 8, label: '哈尔滨' },
{ value: 9, label: '呼伦贝尔' }];exports.travelTags = travelTags;
...
{ value: 7, label: '泰国菜' },
{ value: 8, label: '老白干' },
{ value: 9, label: '精酿' }];exports.foodTags = foodTags;


var characterMap = {
  0: '王者荣耀',
  1: '爱做饭',
  2: '二次元' };exports.characterMap = characterMap;
